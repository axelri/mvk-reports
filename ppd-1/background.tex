...
\subsubsection{GUI}
\label{subsubsec:GUI}
SDK;n ska implementera en simpel GUI där användaren kan välja vad som skall spelas in. Denna panel ska efterlikna The Beta Family's IOs version och därmed glida ner från övre delen av skärmen när denna 'dubbeltappas'. Detta kan exempelvis göras genom att lägga till en animation på panelen vilket ger den visuella effekten som krävs.
