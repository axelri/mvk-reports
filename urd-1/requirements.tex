...
I enlighet med VG-krav 2.2.4~\parencite{vgkrav} finns en GUI-prototyp. Nedan finns en jämförelse med iOS-versionen vilken skall efterliknas så gott det går. iOS-versionen är till höger och vår Android-version till vänster.
...
\subsubsection{Hantering av data}
\begin{tabular}{ | p{65pt} | p{300pt} |}
  \hline
  Identifikator &
  Datahantering
