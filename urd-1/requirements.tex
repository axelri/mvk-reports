...
\subsubsection{Android enheten ska ej vara rootad}
\begin{tabular}{ | p{65pt} | p{300pt} |}
  \hline
  Identifikator &
  Ska ej vara rootad
  \\ \hline
  Beskrivning & 
  En Android enhet som använder sig av SDK:n ska inte behöva vara rootad för att tester ska vara möjliga att genomföra.
  \\ \hline
  Motivering &
  Om enheten måste vara rootad för att ha möjligheten att använda SDK:n så begränsas antalet kompatibla enheter drastiskt då de allra flesta android enheter inte är rootade. Detta innebär då även att antalet personer som kan testa applikationer minskar drastiskt. Allt för att förenkla erfarenheten av att använda SDK:n både för utvecklare och testare.
  \\ \hline
  Behov &
  Maximum
  \\ \hline
  Prioritet &
  Prioriteten är hög då detta är en av de primära kraven för SDK:n.
  \\ \hline
  Källa &
  Dokument med krav från The Beta Family.
  \\ \hline
  Verifiering &
  Kravet verifieras när projektet är färdigställt och kan testas på en android enhet som inte är rootad.
  \\ \hline
\end{tabular}
